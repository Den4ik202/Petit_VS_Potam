...
class Saw(pygame.sprite.Sprite):
    def __init__(self, x: int, y: int, all_sprites: pygame.sprite.Group) -> None:
        ...
        self.image = self.load_image(os.path.abspath(f'data/weapon/saw/saw_weapon.png'))
    ...
    def set_mode(self, state_mode: bool) -> None:
        ...
        if self.mode:
            self.saw_damage = Saw_Damage(self.rect.x, self.rect.y, self.all_sprites)
...
class Saw_Damage(pygame.sprite.Sprite):
    def __init__(self, x: int, y: int, all_sprites: pygame.sprite.Group) -> None:
        pygame.sprite.Sprite.__init__(self)
        self.image = self.load_image(os.path.abspath(f'data/weapon/saw/saw_damage_weapon.png'))
        self.rect = self.image.get_rect()
        self.mask = pygame.mask.from_surface(self.image)
        self.all_sprites = all_sprites
